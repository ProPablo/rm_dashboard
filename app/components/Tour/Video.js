//TODO: fix using props.paused and event lifecycle from parent, also typescript, also play paused buttons do not call props events
...
export default class VideoPlayer extends Component {
  ...
  _onSeek(data = {}) {
    ...
    if (state.scrubbing) {
      ...
      if (!state.seeking) {
        this.setControlTimeout();
        props.paused = state.originallyPaused;
      }
  ...
  initSeekPanResponder() {
    this.player.seekPanResponder = PanResponder.create({
      ...
      onPanResponderGrant: (evt, gestureState) => {
        ...
        this.setSeekerPosition(position);
        state.seeking = true;
        state.originallyPaused = props.paused;
        state.scrubbing = false;
